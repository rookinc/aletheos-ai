const PHASE30_URL = "/json/g900/g900_phase30_combined_graph_export.json";
...
function fallbackPayload() {
  return {
    ...
    renderer_defaults: {
      ...
      available_views: ["combined", "internal_g60", "external_g900", "residue_sheets", "sector_fibers"],
    },
    candidates: [
      {
        id: "gap1_orbit_1",
...
export async function loadG900Phase30() {
  try {
    ...
    console.warn("Using embedded G900 Phase 30 fallback.", err);
