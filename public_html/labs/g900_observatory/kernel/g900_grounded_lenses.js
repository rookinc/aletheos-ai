...
export function getG900GroundedLensSummary(registry, activeLensId = null) {
  ...
  return {
    ...
    render_kind: renderActive ? "body_anchored_long_arc_witness_overlay" : null,
    body_coordinate_claim: renderActive,
    anchor_vertex_ids: renderActive ? ["12:23", "12:24"] : [],
    anchor_source: renderActive ? "native_selector_root_slot_12_limit_23_24" : null,
    display_path_kind: renderActive ? "long_way_projected_arc" : null,
    display_geometry_claim: renderActive ? "screen_space_arc_between_projected_body_anchors" : null,
    moves_terminal_f: false,
    adds_vertices: false,
    adds_edges: false,
