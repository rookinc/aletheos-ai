...
<main class="site-shell research-page">
    ...
    <div class="hero-grid">
      ...
      >
        ...
        <p class="hero-text">
          ...
          auditable structure used to study how local transport, quotient
          geometry, and global coherence can lock together.
        </p>

        <p class="hero-text hero-text--secondary">
          The object has 60 vertices and 120 edges, with a G60/G30/G15 quotient
          tower, a 15 x 30 sector-edge incidence matrix <strong>M</strong>, and
          an exact quadratic identity
          <strong>Q = MM<sup>T</sup> = A<sup>3</sup> + 2A<sup>2</sup> + 2I</strong>
          on the quotient core.
        </p>

        <p class="hero-text hero-text--secondary">
          The graph is not claimed as newly discovered. It has been identified
          with Graph52002 in the House of Graphs and AT4val[60,6] in the
          GraphSym census. The contribution is the transport construction,
          quotient geometry, chamber grammar, and artifact-backed inspection
  ...
  <section class="index-section">
    <div class="section-head">
      <p class="section-kicker">Research origin</p>
      <h2>How the object was found.</h2>
      <p class="section-text">
        This project began in an extended AI-assisted inquiry about time,
        cosmology, memory, consciousness, and accountable intelligence. Over
        many iterations, those questions led to a specific finite graph rather
        than a loose metaphor.
      </p>
      <p class="section-text section-text--spaced">
        CoRI presents that origin plainly, but the public claim does not rest on
        the story of discovery. It rests on the object, its quotient structure,
        its matrix identities, its papers, and its verification artifacts.
      </p>
    </div>
  </section>
