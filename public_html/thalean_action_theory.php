    ...
    <div class="hero-grid">
      <div class="hero-copy">
        ...
        <p class="hero-text hero-text--secondary">
          Its central thesis is that identity is not isolated substance.
  ...
  <section class="index-section">
    <div class="section-head">
      ...
      <p class="section-text">
        ...
        transformation. CoRI supplies the method of witness, perturbation, and
        changed-viewpoint testing.
      </p>
    </div>
    ...
    <div class="card-grid">
      ...
      <article class="index-card">
        ...
        <p>
          Finite graph objects, quotient witnesses, incidence laws, and
          invariants.
        </p>
      </article>
  ...
  <section class="index-section">
    <div class="section-head">
      ...
      <p class="section-text">
        ...
        speculative bridges. The umbrella name does not upgrade the proof status
        of a claim.
      </p>
    </div>
  </section>
